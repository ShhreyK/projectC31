...
function setup() {
  ...
  ground=new Ground(410,790,900,20);

  division=new Division(30,645,20,270);
  division1=new Division(170,645,20,270);
  division2=new Division(330,645,20,270);
  division3=new Division(480,645,20,270);
 
  div=new Division(620,645,20,270);
  div1=new Division(770,645,20,270);
 
  plinko=new Plinko(500,100,30,30);
  plinko1=new Plinko(500,250,30,30);
  plinko2=new Plinko(500,440,30,30);
